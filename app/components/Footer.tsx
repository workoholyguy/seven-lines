...
export default function Footer() {
  return (
    <section className="relative z-40 bg-gradient-to-br from-gray-900 via-slate-800 to-black text-white py-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        {/* Bottom Footer */}
        <div className="border-t border-slate-600/50 mt-4 pt-2 text-center">
