...
export default function Header() {
  ...
  return (
    <header className="top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-md border-b border-slate-600/30 shadow-2xl shadow-blue-500/25 sticky py-0 pt-2 rounded-b-xl">
